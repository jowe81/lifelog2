<?php
  ...
  */
  ...
  $select_options="";  
	if ($res=$ll->db("SELECT * FROM ll2_events WHERE 
					(timestamp<=".time()." AND cat2='piano lessons' AND person=211 AND active=true)
  ...
  <html>
          ...
          <body>
            <div id='mainhead'>
              Tristan's piano lesson notebook 
            </div>
            <div id='container'>
              <div id='menu'>
              ...
              <div id='notes' style='margin-left:20px;'>
                <img src='notepaper_178.jpg' class='stretch' style='position:absolute;z-index:-1;'/>
                <div id='header'></div>
                <div id='actual_notes'></div>
                <div id='footer'></div>
              </div>
            </div>
