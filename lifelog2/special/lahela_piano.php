<?php
	...
	function extract_grade($r) {
		...
		endswitch;
		return "<img $r><span style='color:#D6519C;'> ".$text."</span>";
	}
  ...
  */
  ...
  $select_options="";  
    ...
    $total_avg=number_format(($total/(sizeof($lessons)-$na))-1,2);
    //Recent    
    $weeks=6; 
    $total=0;
    $na=0;
    ...
    $recent_avg=number_format(($total/($weeks-$na))-1,1);
  ...
  <html>
          <head>
            ...
            <script type='text/javascript'>
              $(document).ready(function(){
                  $('#sel').change(function(){
                    $('#notes').load('pno_ajax.php?person=5&lesson_id=' + $('#sel option:selected').val());
                  });
          ...
          <body>
            <div id='mainhead'>
              Lahela's piano lesson notebook 
            </div>
            <div id='container'>
              <div id='menu'>
            ...
            <div id='footerdiv_cont'>
              <div id='footerdiv'>
                ...
                <span style='font-weight:bold;'><a href='pno_notebooks.php'>Back to index</a></span>
              </div>
              <div id='eval'>
