<?php
	...
	if ($res=$ll->db("SELECT * FROM ll2_events WHERE 
					(timestamp>1314860400 AND timestamp<=".time()." AND cat1='work' AND cat2='King Road MB' AND active=true)
	...
	$s->p("<div style='padding:3px;margin:3px;color:#55A;width:905px;background:#E8E8FF;margin-bottom:10px;text-align:center;border:1px dotted #55A;'>This live calculation is powered by LifeLog - A project of <a href='http://www.jowe.de'>http://www.jowe.de</a></div><div style='width:700px;font-size:120%;'><span style='font-size:120%;font-style:italic;'>Johannes Weber, King Road time from September 1, 2011</span>
			...
			<p style='margin-left:20px;margin-top:0px;margin-bottom:0px;'>Grand total (hours since Sep 1, 2011): <span style='color:red;'>".number_format($grandtotal/HOUR,1)."h</span></p>
			<p style='margin-left:20px;margin-top:0px;margin-bottom:0px;'>Average time per week (since Sep 1, 2011): <span style='color:red;'>".number_format(($grandtotal/((time()-1314860400)/WEEK))/HOUR,1)."h</span></p>
			<p style='margin-left:20px;margin-top:0px;margin-bottom:0px;'>Time balance (unpaid hours, since Sep 1, 2011): <span style='color:red;'>$balance</span></p>
			</div>
			<p></p>
